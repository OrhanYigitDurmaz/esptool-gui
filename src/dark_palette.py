...
whiteColor = QColor("#fefefe")  # 255 will become black due to bug in PySide6>=6.2.3 (if applicable)
subtleBlueColor = QColor("#8ab4f7")  # add a little blue highlight to indicate clickable buttons
...
_palette_dark.setColor(QPalette.ColorRole.Light, QColor(25, 25, 25))      # lighter than button color
_palette_dark.setColor(QPalette.ColorRole.Midlight, QColor(30, 30, 30))   # between Button and Light
_palette_dark.setColor(QPalette.ColorRole.Dark, QColor(228, 228, 228))     # darker than Button
_palette_dark.setColor(QPalette.ColorRole.Mid, QColor(63, 63, 63))         # between Button and Dark
_palette_dark.setColor(QPalette.ColorRole.Shadow, QColor(63, 63, 63))      # a very dark color
